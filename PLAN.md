...
**Thirty-three migrations** are written. `0021_recurrences` is applied on the
...
| Money and transition property tests pass | ✅ verified — 130 tests across `src/domain/{money,documents,payments}`, blocking in CI |
