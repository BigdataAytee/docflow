...
import {
  ...
  Trash2, Clock, Send, CheckCircle2, AlertCircle, X, PenLine, GitMerge, Loader2 } from
"lucide-react";
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 bg-red-500/80 hover:bg-red-500/90 backdrop-blur-sm text-white px-5 py-2.5 rounded-2xl text-sm font-bold transition-all active:scale-95 w-fit border border-red-400/30 disabled:opacity-50 hidden">
