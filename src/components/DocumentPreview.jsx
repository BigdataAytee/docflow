...
function SikkyDoc({ form, items, calcs, sym, docType, managerSig, customerSig, T }) {
  ...
  const Header = () => (
    <>
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", padding: "8px 32px 8px 0" }}>
        <div style={{ flexShrink: 0, paddingLeft: 24 }}>
          {form.logo_url
            ? <img src={form.logo_url} alt="logo" style={{ maxHeight: 240, maxWidth: 380, objectFit: "contain", display: "block", marginTop: 0 }} />
            : <div style={{ fontSize: 32, fontWeight: 900, color: accent, fontFamily: "serif" }}>{form.company_name || "Company"}</div>
          }
        </div>
        <div style={{ textAlign: "left", maxWidth: 260, paddingTop: 0, flexShrink: 0, paddingRight: 32 }}>
