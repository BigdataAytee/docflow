...
function SikkyDoc({ form, items, calcs, sym, docType, managerSig, customerSig, T }) {
  ...
  const Header = () => (
    <>
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", padding: "0 32px 8px 24px" }}>
        ...
        <div style={{ textAlign: "left", maxWidth: 260, paddingTop: 16, flexShrink: 0 }}>
