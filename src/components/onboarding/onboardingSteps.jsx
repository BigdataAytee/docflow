...
const ONBOARDING_STEPS = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Separate shipping address per customer",
      "Default currency per customer",
      "Tag and organise your contacts",
    ],
    cta: "Add a Customer",
    ctaPath: "/customers",
    tip: "Start typing a customer's name on any document form and it will auto-complete from your saved contacts.",
    visual: "customers",
  },
  {
    id: "create_document",
    ...
    bullets: [
      ...
      "Apply tax rates & global discounts",
      "Download PDF or send by email directly",
    ],
    cta: "Create a Document",
    ctaPath: "/documents/new",
    tip: "Use the AI Assistant (✨ bottom-right button) to extract line items from a photo or pasted text.",
    visual: "document",
  },
  {
    id: "waybill",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Re-open this guide any time",
      "Setup checklist on your Home dashboard",
      "Contact support if you ever get stuck",
    ],
